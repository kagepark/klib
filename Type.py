...
if __name__ == "__main__":
    ...
    if sys.version_info[0] < 3:
        print('* long:',TypeFixer(long),type(long),',1000000000000000:',Type(1000000000000000,'long'))
    ...
    print(" Type(1,'str'):", Type(1,'str'))
    if sys.version_info[0] < 3:
        print('* unicode:',TypeFixer(unicode),type(unicode),",unicode('3'):",Type(unicode('3'),'unicode'))
